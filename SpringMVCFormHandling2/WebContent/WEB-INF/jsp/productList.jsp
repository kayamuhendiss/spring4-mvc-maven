...
<c:set var="productUrlCategory" value="${pageContext.request.contextPath}/products/category/category"/>
	...
	<section class="container">
		...
		<div class="col-md-6">
			<ul class="nav nav-tabs">
				...
				<li>
					<a href="${productUrlCategory}?categoryName=Laptop">Laptops</a>
				</li>
				<li class="">
					<a href="${productUrlCategory}?categoryName=Tablet">Tablets</a>
				</li>
				<li class="">
